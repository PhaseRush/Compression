...
public:
    ...
    */
    ...
    twoDtree(PNG & imIn); //wtf its right here
    ...
    */
    ...
    bool shouldPrune(Node* node, HSLAPixel avg, double tol);
    void pruneRecursive(Node* root, double tol);

    void renderNode(PNG& im,  Node* &node);

    void clearRecurse(Node* &node);
    void insertRecurse(Node *& thisRoot, Node* otherRoot);
    /**
